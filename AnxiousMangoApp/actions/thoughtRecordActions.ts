...
export const CONST_PTR_SELECT_AUTOMATIC_THOUGHT = "CONST_PTR_SELECT_AUTOMATIC_THOUGHT";
...
export function ptrSelectAutomaticThought(automaticThoughtID: string) {
    return {
        type: CONST_PTR_SELECT_AUTOMATIC_THOUGHT,
        automaticThoughtID
    }
}
